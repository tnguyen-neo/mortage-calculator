...
export default async function AnimatedPhone() {
  return (
    <div
      className="h-[360px] lg:h-[720px] relative flex justify-center"
      style={{
        backgroundImage: `url(${iphone13.src})`,
    ...
    >
      ...
      <TextBubble className="absolute right-0 bottom-1/4 rounded-tl-none">
        Allow users to share links to social media channels like: Facebook,
        Instagram, ...
      </TextBubble>
    </div>
  );
